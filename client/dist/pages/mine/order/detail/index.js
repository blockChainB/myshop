...
var OrderDetail = (_temp2 = _class = function (_BaseComponent) {
  ...
  return OrderDetail;
}(_index.Component), _class.$$events = ["closeTip", "showPayWayBox", "onAnimationEnd", "closePayWay", "checkPayWay", "submitOrder", "showUserAuthModal"], _class.$$componentPath = "pages/mine/order/detail/index", _temp2);
