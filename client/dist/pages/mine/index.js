...
var Shop = (_temp2 = _class = function (_AtBase) {
  ...
  function Shop() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Shop.__proto__ || Object.getPrototypeOf(Shop)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "$compid__60", "isFirst", "SEARCH_BAR_MORE_IMAGE", "showMore", "banner", "floors", "params"], _this.config = {
  ...
  return Shop;
}(_base2.default), _class.$$events = ["toggleShowMore", "connectService", "onGotoPage", "onGotoDetail"], _class.$$componentPath = "pages/mine/index", _temp2);
